...
export default function SplashCursor({
  ...
  BACK_COLOR = { r: 0.5, g: 0, b: 0, a: 0.05 },
  TRANSPARENT = true,
}: SplashCursorProps) {
  ...
  useEffect(() => {
    ...
    function splat(x: number, y: number, dx: number, dy: number, color: ColorRGBA) {
      splatProgram.bind();
    ...
    function updatePointerMoveData(pointer: Pointer, posX: number, posY: number, color: ColorRGBA) {
      pointer.prevTexcoordX = pointer.texcoordX;
      pointer.prevTexcoordY = pointer.texcoordY;
      pointer.texcoordX = posX / canvas!.width;
      pointer.texcoordY = 1 - posY / canvas!.height;
    ...
    function generateColor(): ColorRGBA {
    ...
    function HSVtoRGB(h: number, s: number, v: number): ColorRGBA {
      let r = 0,
        g = 0,
        b = 0;
